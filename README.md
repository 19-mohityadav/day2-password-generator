# Password Generator
A simple password generator app that generates random passwords based on user preferences.
...
- Add custom password characters
...
```bash
git clone https://github.com/devsoc-aec/day2-password-generator.git
```
